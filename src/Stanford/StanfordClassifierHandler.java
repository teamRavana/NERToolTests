...
public class StanfordClassifierHandler extends CRFClassifier<CoreMap> {
    ...
    /**
     * @param propFilePath  : Path to the Properties file (should be located inside
     *                      resources directory)
     * @param trainFilePath : Path to the Training data file
    ...
    /**
     * @param testFilePath   : Path to the Testing data file
     * @param classifierName : Name of the classifier (should be located inside classifiers
     *                       directory)
     */
    public void test(String testFilePath, String classifierName) {
        ...
        ObjectBank<List<CoreLabel>> documents = classifier.makeObjectBankFromFile(testFilePath, readerAndWriter);
    ...
    public void probabilities(String testFilePath, DocumentReaderAndWriter<CoreMap> readerAndWriter) {
        ...
        for (List<CoreMap> doc : makeObjectBankFromFile(testFilePath, readerAndWriter)) {
            Triple<Counter<Integer>, Counter<Integer>, TwoDimensionalCounter<Integer, String>> triple = printProbsDocument(
                    doc);
            if (triple != null) {
